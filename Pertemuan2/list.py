...
print('anggota pertama sudah mendapat giliran presentasi : ', anggota_pertama)

del daftar_kelompok1[0]

print('giliran berikutnya adalah selain anggota pertama :', daftar_kelompok1)

anggota_kedua = daftar_kelompok1[1]
print('anggota kedua sudah mendapat giliran presentasi : ', anggota_kedua)

del daftar_kelompok1[1]

print('giliran berikutnya adalah selain anggota pertama dan kedua :', daftar_kelompok1)
